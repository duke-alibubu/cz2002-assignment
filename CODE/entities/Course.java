...
public class Course {
	...
	public String getCourseCoordinatoerName()
	{
	...
	{
		this.CourseCoordinatorName = new String(CourseCoordinatorName);
	}
	
	public void addLecture(Lecture lecture1)
	{
		this.CourseLecture.add(lecture1);
	}
  
  	public void removeLecture(Lecture lecture1)
	{
		this.CourseLecture.remove(lecture1);
	}
    
	public void addAssessment(Assessment assessment1)
	{
		this.CourseAssessment.add(assessment1);
	}
    	
	public void removeAssessment(Assessment assessment1)
	{
		this.CourseAssessment.remove(assessment1);
	}
	
	public ArrayList<Lecture> getCourseLecture()
	{
